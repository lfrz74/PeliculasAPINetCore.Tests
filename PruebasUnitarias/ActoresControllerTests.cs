...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    public class ActoresControllerTests : BasePruebas
    {
        ...
        public async Task ObtenerPersonasPaginadas()
        {
            ...
            //Resetar httpContext necesario dice
            controller.ControllerContext.HttpContext = new DefaultHttpContext();
        ...
        public async Task CrearActorSinFoto()
        {
            ...
            mock.Setup(x => x.GuardarArchivo(null, null, null, null)) //Sin Foto v
                .Returns(Task.FromResult("url")); //retorna una URL supuestamente
            ...
            //Verificación
            Assert.AreEqual(1, listado.Count); //1 actor creado
            Assert.IsNull(listado[0].Foto); //Sin foto
            Assert.AreEqual(0, mock.Invocations.Count); //nunca se invocó v
        ...
        public async Task CrearActorConFoto()
        {
            ...
            //Prueba
            //Crea un archivo en memoria para emular que es una imagen
        ...
        public async Task PatchActualizaUnSoloCampo()
        {
            ...
            var actor = new Actor() { Nombre = "LFRZ", FechaNacimiento = fechaNacimiento };
            contexto.Add(actor);
            await contexto.SaveChangesAsync();
            ...
            var patchDoc = new JsonPatchDocument<ActorPatchDTO>();
            patchDoc.Operations.Add(new Operation<ActorPatchDTO>("replace", "/nombre", null, "Bizcocho"));
            var respuesta = await controller.Patch(1, patchDoc);
            var resultado = respuesta as StatusCodeResult;
            ...
            Assert.AreEqual("Bizcocho", actorDB.Nombre);
